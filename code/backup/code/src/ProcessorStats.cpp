...
{
	printf("SetMostCommonPatternIndex:%lu\n", index);
	printf("SetMostCommonPattern currLevel:%lu\n", currLevel);
	printf("SetMostCommonPattern count:%lu\n", count);
...
{ 
	printf("GetMostCommonPatternIndex currlevel:%lu\n", currLevel);
	if(mostCommonPatternIndex.size() < currLevel)
	{
		mostCommonPatternIndex.resize(currLevel);
	}
...
{ 
	printf("GetMostCommonPatternCount currlevel:%lu\n", currLevel);
...
{
	printf("SetLevelRecording curlevel :%lu\n", currLevel);
	printf("SetLevelRecording count:%lu\n", count);
	printf("SetLevelRecording size:%lu\n", levelRecordings.size());
...
{
	printf("GetLevelRecording curlevel :%lu\n", currLevel);
	printf("GetLevelRecording size:%lu\n", levelRecordings.size());
	if(levelRecordings.size() < currLevel)
	{
		levelRecordings.resize(currLevel);
	}
...
{
	printf("SeradicationPerlevel size:%lu\n", eradicationsPerLevel.size());
	printf("SeradicationCurrlevel :%lu\n", currLevel);
	printf("SeradicationCount:%lu\n", count);
...
{
	printf("SetCurrentLevel thread :%lu\n", thread);
	printf("SetCurrentLevel level:%lu\n", level);
	printf("SetCurrentLevel size:%lu\n", currentLevelVector.size());
